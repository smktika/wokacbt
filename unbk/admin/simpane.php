...
$sql = mysql_query("update cbt_jawaban set XJawaban = '$_REQUEST[nama]',XKodeJawab = '$ambiljawaban',XNilaiJawab = '$jwb', XNilai='$nil', XTglJawab = '$tgl',XJamJawab = '$jam', Campur = '$tkn', XEssay = '$es'
