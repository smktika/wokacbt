...
<?php $ts=$sj['XTypeSoal']; if($ts=='0'){
	...
	echo "<table border='0' cellpadding='0px' cellspacing='0px'>
        ...
        <label class='drinkcard-cc E' for='E'>&nbsp;</label></td><td class='pilihanjawaban'>$jwbE </td></tr>
			...
			else {$se=$sj['XEssay'];echo "	<form method='post' class='form-jwb'><input type='hidden' name='o' value='O'/>	<input id='soale' type='hidden' name='soale' value='$current_picture'/>"; echo "<strong>Jawaban :</strong><br><textarea  cols='80' rows='6' name='esse' >$se</textarea><br><input type='submit' class='tombol-simpan' value='simpan' name='jawab'></form>"; }
?>
