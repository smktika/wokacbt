...
$hit = 1;
	...
	$sql = mysql_query("insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XKunciJawaban,XA,XB,XC,XD,XE,XTglJawab) values ('$hit','$ambilsoal[XNomerSoal]','$user','$xkodesoal','$xtokenujian','$ambilsoal[XKunciJawaban]','$A1','$B1','$C1','$D1','$E1','$tglbuat')"); 
$hit = $hit+1;
	}
 } } else {
